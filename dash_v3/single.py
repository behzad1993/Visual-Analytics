    ...
    html.Div([
         ...
         html.Div(
             [html.Div([
                         ...
                         html.H5("-Einzelanalyse-", style={"margin-top": "0px"}),])],
             className="one-half column",id="title",
         ),
         
         
         html.Div(
             [html.A(html.Button("Switch to: Vergleichsanalyse", id="learn-more-button"),
                          href="http://127.0.0.1:8080/multiple",)],
...
def run_server():
    app.run_server(debug=True, port=8881, use_reloader=False)
